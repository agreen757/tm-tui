...
func defaultCommandSpecs() []CommandSpec {
	return []CommandSpec{
		...
		{ID: CommandProjectTags, Label: "Project Tags", Description: "Browse project tags and switch", Shortcut: "Alt+Shift+T"},
		{ID: CommandProjectQuickSwitch, Label: "Quick Project Switch", Description: "Switch between recent projects", Shortcut: "Ctrl+Q"},
		{ID: CommandProjectSearch, Label: "Search Projects", Description: "Search tags or projects", Shortcut: "Alt+Shift+Q"},
